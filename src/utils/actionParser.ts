...
export function parseActionData(dataString: string): ActionProperties | null {
  ...
  for (const part of parts) {
    ...
    if (match) {
      ...
      switch (typeCode) {
        case 'X': type = 'Action'; break;
        case 'Z': type = 'Reaction'; break;
        case 'Y': type = 'Both'; break;  // Action & Reaction
        case 'D': type = 'Downtime Action'; break;
        default: continue;
      }
      ...
      switch (frequencyCode) {
        case 'I': frequency = 'instant'; break;
        case 'D': frequency = 'daily'; break;
        case 'C': frequency = 'perCombat'; break;
        case 'T': frequency = 'perTarget'; break;
        default: continue;
      }
